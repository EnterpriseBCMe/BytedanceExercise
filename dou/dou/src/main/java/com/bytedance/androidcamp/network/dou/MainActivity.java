...
public class MainActivity extends AppCompatActivity {
    ...
    private static String myID="Entp";
    private static String myName="syh";
    ...
    private MultipartBody.Part getMultipartFromUri(String name, Uri uri) {
        Log.d(TAG, "RealPath"+ResourceUtils.getRealPath(MainActivity.this, uri));
    ...
    private void postVideo() {
        ...
        miniDouyinService.postVideo("Entp", "syh", coverImagePart, videoPart).enqueue(
